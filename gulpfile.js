...
gulp.task('writePugMixinsFile', function (cb) {
  ...
  let allComponentsWithPugFiles = getDirectories('pugComponents');
  allComponentsWithPugFiles.forEach(function (blockName) {
    pugMixins += `include ../src/${blockName}\r\n`;
  });
  
  fs.writeFileSync(`./_blocks/_all-blocks.pug`, pugMixins);
  cb();
});
...
gulp.task('writeSassMixinsFile', function (cb) {
  ...
  let allComponentsWithSassFiles = getDirectories('sassComponents');
...
gulp.task('live', function () {
  ...
  gulp.watch("./src/components/**/*.pug", gulp.series('writePugMixinsFile', 'pug', 'reload'));
  gulp.watch("./src/**/*.js", gulp.series('js', 'reload'));
  gulp.watch("./src/**/*.jsx", gulp.series('js', 'reload'));
});

gulp.task('watch', gulp.series('autoprefixer', 'minify-css', 'writePugMixinsFile', 'pug', 'js', 'live'), function () {});
